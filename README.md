...
Как вы вызываете функцию у которой нет имени? Мы привязываем ее к событию. Мы говорим браузеру, когда что-то случится вызови эту функцию, называется она ***callback***. Она вызывается когда что-то происходит или готовы какие-то данные.
...
В ***DOM*** есть глобальная переменная `document`  вшитая в каждый html документ, благодаря ей можно получить доступ к множеству узлов, и функционала. В JS есть и другие глобальные переменные, как например `window`.

***[Куки (англ. cookie)](https://ru.wikipedia.org/wiki/Cookie)*** - это способ сообщить сайту, что вы еще в системе. Небольшой фрагмент данных, отправленный веб-сервером и хранимый на компьютере пользователя. Веб-клиент (обычно веб-браузер) всякий раз при попытке открыть страницу соответствующего сайта пересылает этот фрагмент данных веб-серверу в составе HTTP-запроса. Применяется для сохранения данных на стороне пользователя, на практике обычно используется для:
...
Настройка оформления и поведения многих веб-сайтов по индивидуальным предпочтениям пользователя тоже основана на cookie.
...
2. Скрипт (JavaScript) определяет, какая информация необходима для обновления страницы;
...
Это старая популярная библиотека JavaScript, которая «значительно упрощает просмотр и манипуляцию документов HTML, обработку событий, анимацию и Ajax с помощью простого в использовании API, работающего в большинстве браузеров». 

***[$( document ).ready()](https://learn.jquery.com/using-jquery-core/document-ready/)***

***[Selecting Elements](https://learn.jquery.com/using-jquery-core/selecting-elements/)***

***[jQuery’s Ajax-Related Methods](https://learn.jquery.com/ajax/jquery-ajax-methods/)***

На русском, здесь:

***[Русская документация по API jQuery](https://jquery-docs.ru/)***

***[jquery метод $( document ).ready()](http://uroki-jquery.ru/jquery-metod-document-ready.html)***
