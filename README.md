...
<img alt="image" src="images/DNS-names.png"> </img>
...
Существует множество отдельных портов отвечающих за разный функционал, 80 порт это HTTP , 443 порт это HTTPS, 25 порт это SMTP e-mail, 53 порт это DNS
