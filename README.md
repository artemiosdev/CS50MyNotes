...
В ***DOM*** есть глобальная переменнаяучше `document`  вшитая в каждый html документ, благодаря ей можно получить доступ к множеству узлов, и функционала